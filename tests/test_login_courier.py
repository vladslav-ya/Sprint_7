...
class TestLoginCourier:
    ...
    @allure.title('Проверка логин курьера')
    @allure.description('Создание курьера через фикстуру, проверка позитивного сценария логина')
    ...
    @allure.title('Проверка логин курьера без логина')
    @allure.description('Создание курьера через фикстуру, проверка негативного сценария логина')
    ...
    @allure.title('Проверка логин курьера с несуществющим логином и паролем')
    @allure.description('Создание курьера через фикстуру, проверка негативного сценария логина')
